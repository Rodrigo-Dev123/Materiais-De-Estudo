...
class Guerreira extends Personagem {
    ...
    bordao() {
        console.log(this.emoji + ' GUERREIRAAAA AOOOOO ATAAAQUEEEE!!');
    }
}
...
class Monstro extends Personagem {
    ...
    bordao() {
        console.log(this.emoji + ' MONNNNNNNNNNNNSSSTERRRRRRRRRRRRRRR!!');
    }
}
...
monstro.atacar(guerreira);
monstro.atacar(guerreira);
//# sourceMappingURL=A00029-abstract.js.map